    ...
    return (
        <div name="home" className='w-full h-screen bg-[#0a192f] font-sans'>
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h1 className='text-5xl sm:text-7xl font-bold text-[#e1e6f5]' data-aos='fade-right' data-aos-duration="2000">Rameez Qazi</h1>
                <h2 className='text-5xl sm:text-7xl font-bold text-[#8892b0]' data-aos='fade-up' data-aos-duration='2500'>I am a Frontend Web Developer,</h2>
